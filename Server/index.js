...
app.use(
  cors({
    origin: ["blush-bloom-website.vercel.app", "http://localhost:5174"],
    credentials: true,
  })
);
...
app.get(
  ...
  passport.authenticate("google", {
    failureRedirect: "blush-bloom-website.vercel.app/Login",
    session: false,
  }),
  (req, res) => {
    const user = req.user;
   ...
   res.redirect(`blush-bloom-website.vercel.app/google-success?token=${token}`);
  }
);
